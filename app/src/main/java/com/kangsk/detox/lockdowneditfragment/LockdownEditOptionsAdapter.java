...
public class LockdownEditOptionsAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case ITEM_TYPE_TAMPER_OPTION:
                return new LockdownTamperEditOptionViewHolder(inflater.inflate(R.layout.item_lockdown_edit_options_tamper_option, parent, false));
            default:
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        } else if (holder instanceof LockdownTamperEditOptionViewHolder) {
            ((LockdownTamperEditOptionViewHolder) holder).bindModel();
        }
    }
